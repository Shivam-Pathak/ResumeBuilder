...
function printCV(){
    ...
    document.getElementById("preview-sc").style.backgroundColor = "white";
    ...
    myBody.style.backgroundColor = "var(--clr-body-bg)";

    var preview = document.getElementById("preview-sc");
    preview.style.backgroundColor = "var(--clr-body-bg)";
